...
using Services.NetCore.WebApi.Exceptions;
using Services.NetCore.WebApi.Infraestructure.Core;
...
namespace WebServices.NetCore.Criostasis.Infraestructure.Data.UnitOfWork
{
    public class DataContext : DbContext, IQueryableUnitOfWork
    {
        ...
        public DbSet<LogExceptions> LogExceptions { get; set; }
        public DbSet<RequestParameter> RequestParameter { get; set; }
        ...
        private Type GetDomainEntityType(EntityEntry entry)
        {
            ...
            {
                if (type.FullName.Contains("Services.NetCore.WebApi") || type.FullName.Contains("T4"))
                {
                    return type;
                }
